...
public class TextCombinerTest extends FxTest {
    public static final String PATH_TO_FXML = "/layout/TextCombiner.fxml";
    ...
    void initializeGUI(Stage primaryStage) throws IOException {
        ...
        rbOrderAs12 = getById("rbOrderAs12");
        rbOrderAs21 = getById("rbOrderAs21");
        textFields[0] = getById("tfText1");
        textFields[1] = getById("tfText2");
        tfResult = getById("tfResult");
